...
function DeleteString(str)
    ccall((:DeleteString, libhanabi), Cvoid, (Cstring,), str)
end
...
function CardKnowledgeToString(knowledge)
    ccall((:CardKnowledgeToString, libhanabi), Cstring, (Ptr{pyhanabi_card_knowledge_t},), knowledge)
end
...
function MoveToString(move)
    ccall((:MoveToString, libhanabi), Cstring, (Ptr{pyhanabi_move_t},), move)
end
...
function HistoryItemToString(item)
    ccall((:HistoryItemToString, libhanabi), Cstring, (Ptr{pyhanabi_history_item_t},), item)
end
...
function StateToString(state)
    ccall((:StateToString, libhanabi), Cstring, (Ptr{pyhanabi_state_t},), state)
end
...
function NewGame(game, list_length, param_list)
    ccall((:NewGame, libhanabi), Cvoid, (Ptr{pyhanabi_game_t}, Cint, Ptr{Cstring}), game, list_length, param_list)
end

function GameParamString(game)
    ccall((:GameParamString, libhanabi), Cstring, (Ptr{pyhanabi_game_t},), game)
end
...
function ObsToString(observation)
    ccall((:ObsToString, libhanabi), Cstring, (Ptr{pyhanabi_observation_t},), observation)
end
...
function ObservationShape(encoder)
    ccall((:ObservationShape, libhanabi), Cstring, (Ptr{pyhanabi_observation_encoder_t},), encoder)
end

function EncodeObservation(encoder, observation)
    ccall((:EncodeObservation, libhanabi), Cstring, (Ptr{pyhanabi_observation_encoder_t}, Ptr{pyhanabi_observation_t}), encoder, observation)
end
